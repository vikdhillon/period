...
150	WRITE(*,*)ACHAR(7)
	...
	GOTO 999
 	...
 	ELSE IF( PERIOD_PARSE( COMMAND, 'HELP STATUS') ) THEN
	WRITE(FILENAME,'(A)')HELP_DIR
	WRITE(FILENAME(ILEN:),'(A)')'/period_status.hlp'
	DO ILEN2 = 1, 100
	IF (FILENAME(ILEN2:ILEN2) .EQ. ' ') THEN	      
...
370	WRITE(*,*)ACHAR(7)
	...
	GOTO 999
  	...
  	ELSE IF( PERIOD_PARSE( COMMAND, 'HELP FUDGE') ) THEN
	WRITE(FILENAME,'(A)')HELP_DIR
	WRITE(FILENAME(ILEN:),'(A)')'/period_fudge.hlp'
	DO ILEN2 = 1, 100
	IF (FILENAME(ILEN2:ILEN2) .EQ. ' ') THEN	      
